...
save.stats <- "Yes"
file.stats <- paste(name,"stats",Sys.Date(),".csv",sep="")
...
if(save.prop == "Yes"){write.table(all.data, file=paste(file.prop,".csv",sep=""), row.names=TRUE, quote=F, sep=",")}
```
...
if(save.stats== "Yes"){write.table(paste(stats.data, file= file.stats, row.names=TRUE, quote=F, sep=",")}
